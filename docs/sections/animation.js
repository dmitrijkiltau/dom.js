...
export function addAnimationExamples() {
  ...
  // Create tabbed examples for Animation functionality
  const animationTabbedExamples = createTabbedExamples({
    id: 'animation-examples-tabs',
    title: 'Animation Examples',
    description: 'Explore different animation techniques with interactive examples',
    tabs: [
      {
        id: 'basic-animations',
...
dom('#spinner').animate([
  ...
  easing: 'linear'
      ...
      },
      {
        ...
        `,
        code: `import { animations } from '@klt/dom-js';
...
animation.addEventListener('finish', () => {
  ...
  animationSection.append(animationTabbedExamples);
  ...
  dom('#ease-demo').on('click', (ev, el) => {
    ...
    const areaWidth = dom('.demo-area').el().clientWidth - timingBox.el().clientWidth - 16;
