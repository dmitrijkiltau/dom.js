...
// JavaScript
import { useTemplate, renderTemplate } from '@klt/dom-js';
            ...
            <div class="bg-purple-50 border border-purple-200 rounded p-4">
              ...
              <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <code class="text-xs">import dom, { renderTemplate } from '@klt/dom-js';</code><br>
                  <span class="text-gray-600">~13KB total</span>
                </div>
                <div>
                  <strong>Templates Only:</strong><br>
                  <code class="text-xs">import { renderTemplate } from '@klt/dom-js/template';</code><br>
...
import dom, { renderTemplate, useTemplate } from '@klt/dom-js';

// Option 2: Modular Import (Much Smaller!)  
import { renderTemplate, useTemplate } from '@klt/dom-js/template';
// + import dom from '@klt/dom-js/core'; // if you need DOM manipulation
