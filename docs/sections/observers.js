    ...
    tabs: [
      {
        ...
        `,
        code: `import { onIntersect } from '@dmitrijkiltau/dom.js/observers';
  ...
  if (entry.isIntersecting) {
    ...
    stop(); // unobserve
      ...
      },
      {
        ...
        `,
        code: `import { onResize } from '@dmitrijkiltau/dom.js/observers';
...
onResize('#box', (entry, el) => {
  console.log(entry.contentRect.width, entry.contentRect.height);
      ...
      },
      {
        ...
        `,
        code: `import { onMutation } from '@dmitrijkiltau/dom.js/observers';
