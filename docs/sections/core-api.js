...
console.log('Total count:', count);`
  ...
  // New DOM Collection Methods Example
  const newMethodsExample = renderExample({
    id: 'new-dom-methods-example',
    title: 'New DOM Collection Methods',
    description: 'Enhanced DOM manipulation methods: last, filter, remove, empty, clone',
    demo: `
      <div class="space-y-4">
...
dom('.demo-item').remove();`
  ...
  coreSection.append(newMethodsExample);

  // Add interactivity for new methods
  const originalItems = `
    <div class="demo-item p-3 border border-gray-300 rounded bg-gray-50">
      <h4 class="font-medium">Item 1</h4>
      <p>Content for first item</p>
  ...
  // DOM Traversal Methods Example
  const traversalExample = renderExample({
    id: 'dom-traversal-example',
    title: 'DOM Traversal Methods',
    description: 'Navigate the DOM tree: parent, parents, siblings',
    demo: `
      <div class="space-y-4">
        <div class="flex space-x-2">
...
const specificSiblings = dom('.target').siblings('.sibling');`
  ...
  coreSection.append(traversalExample);
  ...
  // Form and Properties Example
  const formPropsExample = renderExample({
    id: 'form-properties-example',
    title: 'Form Values and Properties',
    description: 'Enhanced form handling: val, prop, attrs, serialize',
    demo: `
      <div class="space-y-4">
...
console.log(formData);`
  ...
  coreSection.append(formPropsExample);
  ...
  // Positioning Methods Example
  const positioningExample = renderExample({
    id: 'positioning-example',
    title: 'Element Positioning Methods',
    description: 'Insert content: after, before',
    demo: `
      <div class="space-y-4">
        <div class="flex space-x-2">
...
dom('#target-element')
  ...
  coreSection.append(positioningExample);
